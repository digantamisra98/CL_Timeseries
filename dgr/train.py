...
def train(
    ...
    for task, train_dataset in enumerate(train_datasets, 1):
        ...
        generator_training_callbacks = [
            _generator_training_callback(
        ...
        solver_training_callbacks = [
            _solver_training_callback(
                loss_log_interval=loss_log_interval,
    ...
    def cb(generator, progress, batch_index, result):
        ...
        progress.set_description(
            (
                ...
                percentage=(100.0 * batch_index / total_iterations),
